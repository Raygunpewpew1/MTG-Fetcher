...
var
  ...
  S_DOWNLOAD_URI_FOR_DEFAULT_CARDS_NOT_FOUND: string = 'Download URI for "default_cards" not found.';
  S_DOWNLOADING_BULK_DATA: string = 'Downloading bulk data...';
  S_DOWNLOAD_COMPLETE_FILE_SAVED_TO: string = 'Download complete! File saved to: ';
  ...
  S_NO_CARD_DETAILS_ARE_AVAILABLE_FOR_THIS: string = 'No card details are available for this item.';
  ...
  S_SKIPPING_INVALID_CARD_AT_INDEX_D_S: string = 'Skipping invalid card at index %d: %s';
  S_CARDS_FOUND: string = 'Cards Found: ';
  S_SKIPPING_CARD_MISSING_NAME_OR_ID: string = 'Skipping card: missing "name" or "id".';
